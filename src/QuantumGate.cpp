...
sys_sage::QuantumGate::QuantumGate(const std::vector<Component*>& components, int _id, bool _ordered, size_t _gate_size, const std::string &_name, int _gate_length, QuantumGateType::type _gate_type, double _fidelity, const std::string &_unitary) : Relation(components, _id, _ordered, sys_sage::RelationType::QuantumGate, sys_sage::RelationCategory::Default), gate_size(_gate_size), name(_name), gate_length(_gate_length), gate_type(_gate_type), fidelity(_fidelity), unitary(_unitary) {}
