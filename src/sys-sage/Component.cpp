...
#include <sys-sage/Topology.hpp>  // Needed for sizeof(Topology)
...
sys_sage::Component::Component(Component *_parent, int _id, const std::string &_name): Component(_parent, _id, _name, sys_sage::ComponentType::Generic) {}
