...
namespace sys_sage {
    ...
    public:
         ...
         */
        Chip(int _id = 0, const std::string &_name = "Chip", ChipType::type _type = ChipType::None, const std::string &_vendor = "", const std::string &_model = "");
        /**
         ...
         * Sets componentType to sys_sage::ComponentType::Chip.
         */
        Chip(Component * parent, int _id = 0, const std::string &_name = "Chip", ChipType::type _type = ChipType::None, const std::string &_vendor = "", const std::string &_model = "");
        /**
         * @private
