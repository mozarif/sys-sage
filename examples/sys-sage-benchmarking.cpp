...
// this file benchmarks and prints out performance information about basic
// operations with sys-sage
int main(int argc, char *argv[]) {
  ...
  unsigned total_size =
      n->GetTopologySize(&hwloc_component_size, &caps_numa_dataPathSize);
  ...
  if (numa == NULL) {
    cerr << "numa 0 not found in sys-sage" << endl;
    return 1;
  }
